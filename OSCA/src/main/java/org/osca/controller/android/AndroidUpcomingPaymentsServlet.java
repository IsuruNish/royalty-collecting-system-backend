...
@WebServlet(name = "AndroidUpcomingPaymentsServlet", value = "/AndroidUpcomingPaymentsServlet")
public class AndroidUpcomingPaymentsServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            arr = mem.AndroidGetUpcomingPayments(uid);
