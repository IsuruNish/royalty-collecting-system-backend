...
@WebServlet(name = "SARemoveAdminServlet", value = "/SARemoveAdminServlet")
public class SARemoveAdminServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String name = null;
        try {
            details = saRemoveSOserivice.getAdminsToRemove();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            updated = saRemoveSOserivice.deleteAdmins(basicUser, uid, userType);
            name = saSerivice.getSuperadminName(uid);
