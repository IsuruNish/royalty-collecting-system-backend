...
import org.osca.service.ACheckStatService;
...
@WebServlet(name = "OOCheckStatServlet", value = "/OOCheckStatServlet")
public class OOCheckStatServlet extends HttpServlet {
    @Override
