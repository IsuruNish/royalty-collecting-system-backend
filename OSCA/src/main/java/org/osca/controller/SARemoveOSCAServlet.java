...
@WebServlet(name = "SARemoveOSCAServlet", value = "/SARemoveOSCAServlet")
public class SARemoveOSCAServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String name = null;
        try {
            details = saRemoveSOserivice.getOSCAofficalsToRemove();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            updated = saRemoveSOserivice.deleteOSCAOfficials(basicUser, uid, userType);
            name = saSerivice.getSuperadminName(uid);
