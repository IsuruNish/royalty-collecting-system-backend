...
public class OSCAOfficialDashboard {
    int utype;
    int id;
    String nic;
    String fname;
    ...
    public OSCAOfficialDashboard(int utype, String fname, String DPpath) {
        this.utype = utype;
        this.fname = fname;
        this.DPpath = DPpath;
    }

    public OSCAOfficialDashboard(int utype, int id, String fname, String lname, String email, String phoneNo, int SOnum, int mnum, int licenseReqnum, int songReqnum, Double memberIncome, int concerts, Double oscaIncome, String DPpath) {
        this.utype = utype;
        this.id = id;
        this.fname = fname;
        this.lname = lname;
    ...
    public OSCAOfficialDashboard(int utype, String fname, String lname, String nic, String email, String phoneNo, String DPpath) {
        this.utype = utype;
        this.nic = nic;
        this.fname = fname;
        this.lname = lname;
    ...
    public OSCAOfficialDashboard(int utype) {
        this.utype = utype;
    }

    @Override
    public String toString() {
        return "OSCAOfficialDashboard{" +
                "utype=" + utype +
                ", id=" + id +
                ", fname='" + fname + '\'' +
                ", lname='" + lname + '\'' +
