...
public interface SOCancelLicenseDAO {
//    public CancelLicense getIDs(int uid,int licenseID);
     boolean getIDs(ConcertIDModel concertIDModel) throws SQLException, ClassNotFoundException;
